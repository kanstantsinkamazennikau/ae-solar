...
export const DOCUMENTS_PUBLISHERS_INFO_FILES: DocumentsTypePublisher[] = [
  {
    ...
    data: [
      {
        subtitle: "1. Rechtlicher Rahmen und Grundsätze der Datenverarbeitung",
        paragraphs: [
      ...
      {
        subtitle: "2. Verantwortliche Stelle",
        paragraphs: [
      ...
      {
        subtitle: "3. Begriffsbestimmungen",
        paragraphs: [
          ...
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">a.</div><div>Personenbezogene Daten sind alle Informationen, die sich auf eine identifizierte oder identifizierbare natürliche Person (nachstehend 'betroffene Person' genannt) beziehen. Als identifizierbar wird eine natürliche Person angesehen, die direkt oder indirekt identifiziert werden kann, insbesondere durch Zuordnung zu einer Kennung wie einem Namen, zu einer Kennnummer, zu Standortdaten, zu einer Online-Kennung oder zu einem oder mehreren besonderen Merkmalen, die Ausdruck der physischen, physiologischen, genetischen, psychischen, wirtschaftlichen, kulturellen oder sozialen Identität dieser natürlichen Person sind.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">b.</div><div>Betroffene Person ist jede identifizierte oder identifizierbare natürliche Person, deren personenbezogene Daten von dem für die Verarbeitung Verantwortlichen verarbeitet werden.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">c.</div><div>Verarbeitung ist jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführte Vorgang oder jede solche Vorgangsreihe im Zusammenhang mit personenbezogenen Daten wie das Erheben, das Erfassen, die Organisation, das Ordnen, die Speicherung, die Anpassung oder Veränderung, das Auslesen, das Abfragen, die Verwendung, die Offenlegung durch Übermittlung, Verbreitung oder jede andere Form der Bereitstellung, den Abgleich oder die Verknüpfung sowie das Einschränken, Löschen oder Vernichten.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">d.</div><div>Einschränkung der Verarbeitung ist die Markierung gespeicherter personenbezogener Daten mit dem Ziel, ihre künftige Verarbeitung einzuschränken.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">e.</div><div>Profiling ist jede Art der automatisierten Verarbeitung personenbezogener Daten, die darin besteht, dass diese personenbezogenen Daten verwendet werden, um bestimmte persönliche Aspekte, die sich auf eine natürliche Person beziehen, zu bewerten, insbesondere um Aspekte bezüglich Arbeitsleistung, wirtschaftlicher Lage, Gesundheit, persönlicher Vorlieben, Interessen, Zuverlässigkeit, Verhalten, Aufenthaltsort oder Ortswechsel dieser natürlichen Person zu analysieren oder vorherzusagen.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">f.</div><div>Pseudonymisierung ist die Verarbeitung personenbezogener Daten in einer Weise, auf welche die personenbezogenen Daten ohne Hinzuziehung zusätzlicher Informationen nicht mehr einer spezifischen betroffenen Person zugeordnet werden können, sofern diese zusätzlichen Informationen gesondert aufbewahrt werden und technischen und organisatorischen Maßnahmen unterliegen, die gewährleisten, dass die personenbezogenen Daten nicht einer identifizierten oder identifizierbaren natürlichen Person zugewiesen werden.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">g.</div><div>Verantwortlicher oder für die Verarbeitung Verantwortlicher ist die natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet. Sind die Zwecke und Mittel dieser Verarbeitung durch das Unionsrecht oder das Recht der Mitgliedstaaten vorgegeben, so kann der Verantwortliche beziehungsweise können die bestimmten Kriterien seiner Benennung nach dem Unionsrecht oder im Recht der Mitgliedstaaten vorgesehen werden.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">h.</div><div>Auftragsverarbeiter ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die personenbezogene Daten im Auftrag und nach Weisung des für die Verarbeitung Verantwortlichen gemäß Artikel 28 DSGVO und Artikel 9 DSGVO verarbeitet.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">i.</div><div>'Empfänger' ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, der personenbezogene Daten offengelegt werden, unabhängig davon, ob es sich bei ihr um einen Dritten handelt oder nicht. Behörden, die im Rahmen eines bestimmten Untersuchungsauftrags nach dem Unionsrecht oder dem Recht der Mitgliedstaaten möglicherweise personenbezogene Daten erhalten, gelten jedoch nicht als Empfänger.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">j.</div><div>'Dritter' ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle außer der betroffenen Person, dem Verantwortlichen, dem Auftragsverarbeiter und den Personen, die unter der unmittelbaren Verantwortung des Verantwortlichen oder des Auftragsverarbeiters befugt sind, die personenbezogenen Daten zu verarbeiten.</div></div`,
          `<div style="display: flex; gap: 8px;"><div style="min-width: 20px;">k.</div><div>Einwilligung ist jede von der betroffenen Person freiwillig für den bestimmten Fall in informierter Weise und unmissverständlich abgegebene Willensbekundung in Form einer Erklärung oder einer sonstigen eindeutigen bestätigenden Handlung, mit der die betroffene Person zu verstehen gibt, dass sie mit der Verarbeitung der sie betreffenden personenbezogenen Daten einverstanden ist.</div></div`,
        ],
      },
    ],
  },
  {
    ...
    data: [
      ...
      {
        subtitle: "2. Widerruf Ihrer Einwilligung zur Datenverarbeitung",
        paragraphs: [
      ...
      {
        subtitle: "3. Beschwerderecht bei der zuständigen Aufsichtsbehörde",
        paragraphs: [
          ...
          `Deutsche Beschwerdestelle:<br /><a href="https://www.bfdi.bund.de/DE/Service/Anschriften/Laender/Laender-node.html">https://www.bfdi.bund.de/DE/Service/Anschriften/Laender/Laender-node.html</a><br />BfDI - Landesbehörden (bund.de)`,
          `EU-Beschwerdestelle:<br />Beschwerden | European Data Protection Supervisor (europa.eu)`,
  ...
  },
  {
    ...
    data: [
      ...
      {
        subtitle: "6. Anmeldung zu unserem Newsletter",
        paragraphs: [
      ...
      {
        subtitle: "6a. Newsletter-Verfolgung",
        paragraphs: [
      ...
      {
        subtitle: "7. Automatisierte Verarbeitungen und Verwendung von Cookies",
        paragraphs: [
          ...
          CM14 1209600 Prüfen Sie, ob das Partner-Cookie neu synchronisiert werden muss (Cookie auf Cookie-Synchronisation gesetzt) token Ende der Sitzung (Browser)<br />
          otsid 3650 Tage<br />
          uid 5184000 Enthält eine eindeutige Kennung zur Identifizierung des Benutzers<br />
          ...
          SR 86400 Informationen zur sequentiellen Rotation – einschließlich Gesamtimpressionen, Tagesimpressionen, Gesamtklicks, Tagesklicks und Datum der letzten Impression<br />
          CT 3600 Identifizieren Sie Drittanbieter-Pixel-Zuordnungen für den letzten Klick auf den Seiten von Werbetreibenden<br />
          EBFCD 604800 Bestimmen Sie das tägliche Häufigkeitslimit für Expanding-Banner<br />
          CFFC 604800<br />
          C 60 Tage bis 3650 Tage Wird verwendet, um festzustellen, ob der Browser des Benutzers Cookies akzeptiert<br />
          SR 1 Tag Einzigartige Metriken zum Aufzeichnen laufender Anzeigeninformationen – einschließlich: Gesamtzahl der Impressionen, tägliche Impressionen, Gesamtzahl der Klicks, tägliche Klicks und Datum der letzten Impression<br />
          CT 1 Stunde Identifizieren Sie Drittanbieter-Pixel-Zuordnungen für den letzten Klick auf den Seiten von Werbetreibenden<br />
          EBFCD 7 Tage Erfassen Sie die maximale Anzahl von Impressions pro Tag (Häufigkeitslimit), um die Anzeige zu vergrößern (erweiterbar)<br />
          EBFC 7 Tage Maximale Gesamtimpressionen für registrierte erweiterbare Anzeigen (erweiterbar) (Häufigkeitslimit)<br />
          CFFC 7 Tage Maximale Anzahl von Impressionen zur Registrierung zusammengesetzter Banner (Häufigkeitsgrenze)<br />
          ...
          SR(RotatorID) 1 Tag Informationen zur sequentiellen Rotation – einschließlich Gesamtimpressionen, Tagesimpressionen, Gesamtklicks, Tagesklicks und Datum der letzten Impression<br />
          ...
          EBFCD(BannerID) 7 Tage Legt das tägliche Häufigkeitslimit für erweiterte Banner fest.<br />
          EBFC(BannerID) 7 Tage Bestimmen Sie das allgemeine Häufigkeitslimit für erweiterte Banner<br />
          ...
          _ga 24 Monate Sammeln Sie Statistiken über die Nutzung der Website. (Abstandsmessung)<br />
          _gid 24 Stunden Dieses Cookie wird verwendet, um Website-Nutzungsstatistiken zu sammeln.<br />
          _gac_gb_* 90 Tage Enthält Informationen zur Veranstaltung. Wenn Sie Ihr Google Analytics-Konto mit Ihrem Google Ads-Konto verknüpft haben, liest die Registerkarte „Conversions“ auf der Google Ads-Website dieses Cookie, sofern Sie diese Funktion nicht deaktivieren.<br />
          ...
          `Cookies:<br />
          Name Lebensdauer Beschreibung<br />
          cookiePreferences 2 Jahre Cookie-Einstellungen für registrierte Benutzer<br />
          mat_ep n.a. Sammeln Sie seitenübergreifende Besucherdaten - diese Daten werden verwendet, um die Werberelevanz zu erhöhen.<br />
          ...
          `Cookies:<br />
          Name Lebensdauer Beschreibung<br />
          _hjClosedSurveyInvites 31557600 Das Hotjar-Cookie wird gesetzt, sobald der Benutzer über einen externen Link mit dem Umfrageeinladungsmodus interagiert. Dies wird verwendet, um sicherzustellen, dass dieselbe Einladung, wenn sie bereits angezeigt wurde, nicht erneut angezeigt wird.<br />
          _hjDonePolls 31557600 Glas mit heißen Keksen. Dieses Cookie wird gesetzt, sobald ein Besucher mit dem Umfrage-Widget abgestimmt hat. Dies wird verwendet, um sicherzustellen, dass derselbe Datensatz nicht erneut angezeigt wird, wenn er bereits erstellt wurde.<br />
          _hjMinimizedPolls 31557600 Glas mit heißen Keksen. Dieses Cookie wird gesetzt, sobald ein Besucher das Umfrage-Widget für Kommentare minimiert. Dies wird verwendet, um sicherzustellen, dass Widgets minimal bleiben, während Besucher Ihre Website durchsuchen.<br />
          _hjShownFeedbackMessage 31557600 Hotjar-Cookies werden gesetzt, wenn der Benutzer eingehende Kommentare minimiert oder vervollständigt. Dies geschieht, damit der Benutzer, wenn er zu einer anderen Seite navigiert, die zur Anzeige konfiguriert ist, die eingehenden Kommentare sofort minimiert lädt.<br />
          ...
          hjViewportId 0 Hier werden Informationen über den Betrachtungsbereich des Benutzers wie Größe und Abmessungen gespeichert.<br />
          _hjRecordingEnabled n.a. Dies wird an den Beginn der Aufzeichnung angehängt und abgespielt, wenn die Aufzeichnungs-Engine initialisiert wird, um zu sehen, ob der Benutzer bereits in einer bestimmten Sitzung aufzeichnet.<br />
          ...
          _hjSession{site_id} 1800 Dieses Cookie enthält aktuelle Sitzungsdaten. Dadurch wird sichergestellt, dass nachfolgende Anfragen im Sitzungsfenster derselben Hotjar-Sitzung zugeordnet werden.<br />
          _hjSessionTooLarge n.a. Dieses Cookie zwingt Hotjar, die Datenerfassung zu beenden, wenn die Sitzung zu lang wird. WebSocket-Serversignale erkennen dies automatisch, wenn die Sitzungsgröße das Limit überschreitet.<br />
          _hjSessionRejected n.a. Falls vorhanden, wird dieses Cookie für die Dauer einer Benutzersitzung auf „1“ gesetzt, wenn Hotjar aufgrund einer Serverüberlastung die Verbindung der Sitzung mit dem WebSocket verweigert. Dieses Cookie wird nur in seltenen Fällen verwendet, um schwerwiegende Leistungsprobleme zu vermeiden.<br />
          ...
          _hjDoneTestersWidgets 365 Tage Glas mit heißen Keksen. Dieses Cookie wird gesetzt, sobald ein Besucher seine Informationen in das Widget „Recruit User Testers“ eingibt. Dies wird verwendet, um sicherzustellen, dass das gleiche Formular nach dem Ausfüllen nicht erneut angezeigt wird.<br />
          _hjMinimizedTestersWidgets 365 Tage Glas mit heißen Keksen. Dieses Cookie wird gesetzt, wenn ein Besucher das Benutzertester-Widget der Website minimiert. Dies wird verwendet, um sicherzustellen, dass Widgets minimal bleiben, während Besucher Ihre Website durchsuchen.<br />
          _hjptid Sitzung Dieses Cookie wird für Hotjar-Benutzer gesetzt, die mit Administratorrechten für Teammitglieder angemeldet sind. Dies wird für Preistests verwendet, um Administratoren konsistente Preise auf der gesamten Website anzuzeigen.<br />
          _hjSession_ 30 Minuten Ein Cookie, das Daten aus der aktuellen Sitzung enthält. Dadurch werden nachfolgende Anfragen im Sitzungsfenster derselben Hotjar-Sitzung zugeordnet.<br />
          _hjRecordingLastActivity Session Es muss sich im Sitzungsspeicher befinden (im Gegensatz zu einem Cookie). Es wird aktualisiert, wenn die Benutzerbefragung beginnt und wenn Daten über WebSocket gesendet werden (Benutzer führt Aktionen aus, die von Hotjar aufgezeichnet werden).<br />
          _hjSession.* n.a. Ein Cookie, das Daten aus der aktuellen Sitzung enthält. Dadurch werden nachfolgende Anfragen im Sitzungsfenster derselben Hotjar-Sitzung zugeordnet.<br />
          _hjViewportId n.a. Benutzeransichtsfensterinformationen wie Größe und Abmessungen werden hier gespeichert.<br />
          ...
          `Cookies:<br />
          Name Lebensdauer Beschreibung<br />
          _uetsid 1800 Dies ist ein Tracking-Cookie, das für gezielte Werbung verwendet wird.<br />
          MUID 33696000 Dies ist ein Benutzer-ID-Tracking-Cookie, das verwendet wird, um gültige Klicks auf gezielte Werbung zu zählen.<br />
          MUIDB 33696000 Dies ist ein Benutzer-ID-Tracking-Cookie, das von Microsoft Bing Ads für gezielte Werbung verwendet wird.<br />
          ...
          `Cookies:<br />
          Name Lebensdauer Beschreibung<br />
          outbrain_cid_fetch n.a. Dieses Cookie bestimmt, wie der Benutzer auf die Website zugreift. Website-Betreiber verwenden diese Informationen, um die Effektivität ihres Marketings zu messen.<br />
          cookieJartestCookie 1 Tag<br />
          obuid 3 Monate Ein Cookie des Outbrain-Anbieters weist einem Benutzer eine eindeutige Kennung zu, die es Drittanbietern ermöglicht, relevante Werbung anzuzeigen.<br />
          ...
          criteo 1 Monat Ein Cookie des Outbrain-Anbieters weist einem Benutzer eine eindeutige Kennung zu, die es Drittanbietern ermöglicht, relevante Werbung anzuzeigen.<br />
          mdfrc 4 Monate Verwendung in Verbindung mit SEO und Conversion-Optimierung. Sammeln Sie alle Benutzerberichte oder Verhaltensdaten im Website-Eigentümerbericht. Dieser Dienst wird von einem Analysedienst eines Drittanbieters bereitgestellt.<br />
          adrl 4 Monate Dieses Cookie speichert Daten über den Besucher. Diese Informationen werden verwendet, um die Anzeigenrelevanz zu optimieren.<br />
          ttd 4 Monate Verwendung in Verbindung mit SEO und Conversion-Optimierung. Sammeln Sie alle Benutzerberichte oder Verhaltensdaten im Website-Eigentümerbericht. Dieser Dienst wird von einem Analysedienst eines Drittanbieters bereitgestellt.<br />
          bdswch 3 Monate Wird verwendet, um Besuchern relevante Inhalte und Werbung anzuzeigen. - Der Dienst wird von einem Drittanbieter-Werbezentrum bereitgestellt, das es Werbetreibenden ermöglicht, in Echtzeit zu bieten.<br />
          pwrlnks 29 Tage Sammeln Sie Daten über Benutzerbesuche auf der Website, wie z. B. Anzahl der Besuche, durchschnittlich auf der Website verbrachte Zeit und besuchte Seiten.<br />
          adot 29 Tage Sammeln Sie Daten über Benutzerbesuche auf der Website, wie z. B. Anzahl der Besuche, durchschnittlich auf der Website verbrachte Zeit und besuchte Seiten.<br />
          zmnta 29 Tage Sammeln Sie Daten über die Navigation und das Verhalten der Benutzer auf der Website. Es wird verwendet, um statistische Berichte und Heatmaps für Website-Betreiber zu erstellen.<br />
          rtbhs 29 Tage Sammeln Sie Informationen über Benutzerpräferenzen und/oder Interaktionen mit Webkampagneninhalten – dies ist die CRM-Kampagnenplattform, die der Websitebesitzer verwendet, um Kampagnen oder Produkte zu bewerben.<br />
          sid_key Session<br />
          actvagnt 29 Tage Sammeln Sie Informationen über das Benutzerverhalten auf verschiedenen Websites. Diese Informationen werden verwendet, um die Relevanz von Anzeigen auf der Website zu optimieren.<br />
          sid Session<br />
          Rechtliche Grundlage<br />
          Einwilligung, Art. 6 Abs. 1 lit. a DSGVO`,
          `Ort der Verarbeitung<br />
          ...
          _twitter_sess Sitzung Twitter verwendet diese Cookies in Verbindung mit Social Plugins, um es Benutzern zu ermöglichen, Twitter-Konten einfach zu folgen, Inhalte zu teilen und die neuesten Tweets zu sehen.<br />
          ads_prefs 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          auth_token 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          csrf_same_site 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          csrf_same_site_set 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          dnt 2 Jahre Dies sind Twitter-Cookies von Drittanbietern. Diese Cookies ermöglichen es Benutzern, sich bei ihrem Twitter-Konto anzumelden, wenn sie Inhalte auf unserer Website mit ihren Freunden teilen möchten. Diese Cookies ermöglichen es uns nicht, auf Ihr Konto zuzugreifen oder uns vertrauliche Informationen über Ihr Konto bereitzustellen. Diese Cookies ermöglichen auch das Erscheinen von Tweet-Newsfeeds auf der Website.<br />
          ...
          external_referer 2 Jahre Unsere Website verwendet eine Twitter-Schaltfläche, damit unsere Besucher unserem Werbe-Twitter-Feed folgen können, manchmal ist der Feed auf unserer Website eingebettet.<br />
          ...
          remember_checked_on 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          rweb_optin 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          syndication_guest_id 2 Jahre Um Informationen über das Surfverhalten der Benutzer für Marketingzwecke zu sammeln, einschließlich digitaler Anzeigen und Werbung in sozialen Medien.<br />
          twid 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          tfw_exp 2 Jahre Diese Cookies ermöglichen es uns, die Besucheraktivitäten für Twitter-Anzeigen auf unserer Website zu verfolgen und Benutzern zu ermöglichen, Inhalte auf unserer Website zu teilen. Diese Cookies liefern uns keine vertraulichen Informationen über Ihr Konto.<br />
          ct0 persistant Dieses Cookie wird für die Twitter-Integration und die Freigabefunktion verwendet.<br />
          guest_id zwei Jahre Dieses Cookie wird für die Twitter-Integration und die Freigabefunktion verwendet.<br />
          personalization_id zwei Jahre Wird von Twitter.com verwendet, um die Anzahl der Website-Besucher durch Twitter-Werbeinhalte zu ermitteln, die für gezielte Werbung verwendet werden können.<br />
          pid n.a. Dieses Cookie ermöglicht Website-Besuchern, Twitter-bezogene Funktionen auf den von ihnen besuchten Websites zu verwenden.<br />
          external_reference 7 Tage Dieses Cookie wird für die Twitter-Integration und die Freigabefunktion verwendet.<br />
          lang Session<br />
          remember_check_on Unbekannt Dieses Cookie wird für die Twitter-Integration und die Freigabefunktion verwendet.<br />
          ...
          `Cookies:<br />
          Name Lebensdauer Beschreibung<br />
          test_cookie 900 Testen Sie, ob Ihr Browser die Installation von Cookies zulässt. Enthält keine Identifikatoren.<br />
          IDE 31557600 Enthält eine zufällig generierte Benutzer-ID. Mit dieser ID kann Google Nutzer auf verschiedenen Websites identifizieren und ihnen personalisierte Werbung anzeigen.<br />
          _gcl_aw 7776000 Dieses Cookie wird gesetzt, wenn ein Nutzer auf eine Google-Anzeige klickt, um eine Website zu besuchen. Sie enthält Informationen über die angeklickte Anzeige, sodass Erfolge wie eine Bestellung oder eine Kontaktanfrage der Anzeige zugeordnet werden können.<br />
          ...
          `Cookies:<br />
          Name Lebensdauer Beschreibung<br />
          _fbp 3 Monate Facebook-Cookies werden für Website-Analysen, Targeting und Anzeigenmessung verwendet.<br />
          act 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          c_user 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          datr 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          fr 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          m_pixel_ration 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          pl 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          presence 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          sb 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          spin 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          wd 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          xs 1 Jahr Facebook-Cookies für Website-Analysen, Ad-Targeting und Messung.<br />
          AA003 3 Monate Sammeln Sie Informationen über das Besucherverhalten auf verschiedenen Websites. Diese Informationen werden auf der Website verwendet, um die Relevanz von Anzeigen zu optimieren.<br />
      ...
      },
      {
        ...
        paragraphs: [
          ...
          Spracheinstellung`,
          `Außerdem wird erfasst:<br />
          Ihr ungefährer Standort (Region)<br />
          Ihre IP-Adresse (in gekürzter Form)<br />
          technische Informationen zu Ihrem Browser und den von Ihnen genutzten Endgeräten (z.B. Spracheinstellung, Bildschirmauflösung)<br />
          Ihr Internetanbieter<br />
          die Referrer-URL (über welche Website/ über welches Werbemittel Sie auf diese Website gekommen sind)<br />
          ...
          `Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland (als Auftragsverarbeiter nach Art. 28 DSGVO)<br />
          ...
          `Widerruf: Sie können Ihre Einwilligung jederzeit mit Wirkung für die Zukunft widerrufen, indem Sie die Cookie-Einstellungen aufrufen und dort Ihre Auswahl ändern:<br />
          ...
          `<div style="display: flex; gap: 8px;"><div>a.</div><div>Ihre Einwilligung in das Setzen des Cookies nicht erteilen oder</div></div`,
          `<div style="display: flex; gap: 8px;"><div>b.</div><div>das Browser-Add-on zur Deaktivierung von Google Analytics hier herunterladen und installieren.</div></div`,
        ],
      },
      {
        subtitle: "10. Empfängerkreis; Drittlandtransfer",
        paragraphs: [
          ...
          `englisch<br />
          <a href="https://commission.europa.eu/law/law-topic/data-protection/international-dimension-data-protection/adequacy-decisions_en">https://commission.europa.eu/law/law-topic/data-protection/international-dimension-data-protection/adequacy-decisions_en</a>`,
          `deutsch<br />
          <a href="https://commission.europa.eu/law/law-topic/data-protection/international-dimension-data-protection/adequacy-decisions_de?etrans=de">https://commission.europa.eu/law/law-topic/data-protection/international-dimension-data-protection/adequacy-decisions_de?etrans=de</a>`,
          ...
          <a href="https://commission.europa.eu/publications/standard-contractual-clauses-international-transfers_de">https://commission.europa.eu/publications/standard-contractual-clauses-international-transfers_de</a> )`,
          ...
          `<a href="https://www.dataprivacyframework.gov/s/participant-search">https://www.dataprivacyframework.gov/s/participant-search</a>`,
        ],
      },
      {
        subtitle: "10. Minderjährige",
        paragraphs: [
  ...
  },
  {
    ...
    data: [
      ...
      {
        subtitle: "2. Nutzung des Solarrechners",
        paragraphs: [
    ...
    data: [
      {
        ...
        paragraphs: [
          ...
          `Insbesondere können die folgenden Datenkategorien verarbeitet werden:<br />
          Allgemeine personenbezogene Daten (Name, Anschrift und sonstige Kontaktdaten, Bewerbungsfoto, Geburtsdaten, Staatsangehörigkeit, Familienstand, sonstige (ggf. auch sensible) Daten, die Sie uns mitteilen)<br />
          Berufsbezogene Daten (berufliche Kontaktinformationen, derzeitige Position, Verantwortlichkeiten/Zuständigkeiten, derzeitiger Arbeitgeber, derzeitige Vergütung, Kündigungsfrist, Besitzstand, Sperrvermerke).<br />
          Erfahrungsbezogene Daten (frühere Positionen und Arbeitgeber, Schul- und Hochschulbildung, Berufsausbildung, Erfahrung, Kenntnisse)<br />
          Zukunftsbezogene Daten (Wünsche und Vorstellungen, Einschätzungen, denkbare Einsatzgebiete, Vermittlungsideen)<br />
