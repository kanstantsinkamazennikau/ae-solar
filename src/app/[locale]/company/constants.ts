...
export const ABOUT_EXPLORE_CENTER = `Entdecken Sie 
unseren Unterschied.`;
export const ABOUT_EXPLORE_CENTER_MOBILE = `Erkunden Sie 
unseren Unterschied.`;
...
export const ABOUT_HISTORY = [
  {
    year: 2003,
    event:
      "AE Solar wurde als familiengeführtes Unternehmen für die Installation von PV-Systemen in Königsbrunn, Deutschland, gegründet",
  },
  {
    year: 2009,
    event:
      "Es wurde eine manuelle Montage von Mono-/Poly-PV-Modulen mit einer Produktionskapazität von 50 MW pro Jahr eingerichtet",
  },
  {
    year: 2012,
    event: "Die Herstellung von doppelt verglasten und bifazialen PV-Modulen wurde gestartet",
  },
  {
    year: 2013,
    event:
      "Eine halbautomatisierte Fertigungslinie für PV-Module mit einer Produktionskapazität von 150 MW pro Jahr wurde installiert",
  },
  {
    year: 2014,
    event: "Die automatisierte Lötarbeit für PV-Modulstränge wurde implementiert",
  },
  {
    year: 2016,
    event:
      "Es wurde eine automatisierte Produktionslinie für PV-Module mit einer Kapazität von 250 MW pro Jahr installiert; Shading-resistente Hot-Spot-freie PV-Module wurden erfunden",
  },
  {
    year: 2017,
    event:
      "Auszeichnung als eines der Top 10 Highlights der SNEC 2017 PV Power Expo;<br/> Die Serienproduktion von schattierungsresistenten, hot-spot-freien PV-Modulen wurde gestartet.;<br/> Es wurde eine vollautomatisierte Produktionslinie für PV-Module mit einer Kapazität von 525 MW pro Jahr installiert",
  },
  {
    year: 2018,
    event: "Auszeichnung für die Top-Innovation des Jahres 2018 von PV Magazine",
  },
  {
    year: 2019,
    event:
