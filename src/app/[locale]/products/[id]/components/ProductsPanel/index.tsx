...
export default function ProductsPanel({ id }: ProductsPanelProps) {
  return (
    <div className="w-full flex justify-center items-center relative -top-[64px] h-screen">
      <Image
        src="/images/products/productBackground.svg"
      ...
      <div className="absolute bottom-[13%]">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3 w-min">
            ...
            <p className="font-walsheim [font-size:_clamp(12px,1.5vw,24px)] leading-[150%] font-medium text-center">
              Embracing the Light of the Sun: Passivated Emitter and Rear Cell
              (PERC) Technology for Superior Solar Modules
            </p>
          </div>
        </div>
      </div>
